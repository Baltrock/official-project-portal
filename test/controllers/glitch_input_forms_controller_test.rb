...
class GlitchInputFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create glitch_input_form" do
    assert_difference("GlitchInputForm.count") do
      post glitch_input_forms_url, params: { glitch_input_form: { glitch_message: @glitch_input_form.glitch_message, glitch_title: @glitch_input_form.glitch_title, riddle_hint: @glitch_input_form.riddle_hint, spoiler_hint_: @glitch_input_form.spoiler_hint_ } }
    end
  ...
  test "should update glitch_input_form" do
    patch glitch_input_form_url(@glitch_input_form), params: { glitch_input_form: { glitch_message: @glitch_input_form.glitch_message, glitch_title: @glitch_input_form.glitch_title, riddle_hint: @glitch_input_form.riddle_hint, spoiler_hint_: @glitch_input_form.spoiler_hint_ } }
