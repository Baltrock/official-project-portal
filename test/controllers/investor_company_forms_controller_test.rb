...
class InvestorCompanyFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investor_company_form" do
    assert_difference("InvestorCompanyForm.count") do
      post investor_company_forms_url, params: { investor_company_form: { company_address: @investor_company_form.company_address, company_name: @investor_company_form.company_name, company_website_link: @investor_company_form.company_website_link, interest_reason: @investor_company_form.interest_reason, talk_availability: @investor_company_form.talk_availability } }
    end
  ...
  test "should update investor_company_form" do
    patch investor_company_form_url(@investor_company_form), params: { investor_company_form: { company_address: @investor_company_form.company_address, company_name: @investor_company_form.company_name, company_website_link: @investor_company_form.company_website_link, interest_reason: @investor_company_form.interest_reason, talk_availability: @investor_company_form.talk_availability } }
